...
public class ServletUsuarioRegister extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String eps_usaurio = request.getParameter("eps_usuario");
        int citas_usuario = Integer.parseInt(request.getParameter("citas_usuario"));
        boolean premium = Boolean.parseBoolean(request.getParameter("premium"));
        		
        String result = usuario.register(username, pass, nombre_usuario, 
                apellido_usuario, email_usuario, eps_usaurio, citas_usuario, premium);
